...
use super::hash_deque::{HashDeque, HashSlabDeque};
...
pub struct HashSlabLru<T, S> {
    pub deque: HashSlabDeque<T, S>,
    pub capacity: usize,
}

impl<T, S> HashSlabLru<T, S>
where
    T: Copy,
{
    pub fn with_capacity_and_hasher(capacity: usize, hasher: S) -> Self {
        let deque = HashSlabDeque::with_capacity_and_hasher(capacity, hasher);
        Self { deque, capacity }
    }
}
...
impl<T, S> Debug for HashSlabLru<T, S>
where
    T: Debug + Copy + Hash + Eq,
    S: BuildHasher,
{
